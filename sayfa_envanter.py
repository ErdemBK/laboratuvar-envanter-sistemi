...
class EnvanterSayfasi(ctk.CTkFrame):
    def __init__(self, master, app):
        ...
        # Arayüzü sadece BİR kere kuruyoruz
    ...
    def stok_guncelle_penceresi(self, malzeme_id):
        ...
        def satir(isim, m_val, b_val):
            ...
            c = ctk.CTkComboBox(f, values=birimler, width=120); c.set(b_val if b_val in birimler else ""); c.pack(side="left")
            return e, c
        ...
        def kaydet():
            try:
                ...
                log_id = self.db.gecmis_ekle(malzeme_id, eski_m.isim, IslemTipi.GUNCELLEME.value, self.app.kullanici_adi)
    ...
    def malzeme_sil_islemi(self, m_id):
        ...
        if m:
            ...
            log_id = self.db.gecmis_ekle(m_id, m.isim, IslemTipi.SILME.value, self.app.kullanici_adi)
